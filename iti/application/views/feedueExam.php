...
<form action="<?php echo base_url();?>index.php/feeControllers/enterExamfee" method="post" role="form" class="smart-wizard form-horizontal"
	id="form">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-white">
				...
				<div class="panel-body">
					<div class="alert alert-info">
						...
						<br> This is Examination fee Area. Here you have to enter Exam Fee with the
					...
					<div class="col-md-5">
						<div class="panel">
							...
							<div class="panel-body">
								...
								<div class="row space15">
									<div class="col-md-5">Exam Due</div>
									<div class="col-md-7">
