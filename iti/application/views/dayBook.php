			...
			<div class="panel-body">
                ...
                <div class="row">
            		 <div class="col-md-12 space20" >
                     	...
                     	<div class="col-md-2">
                        		<input type="radio" name="check_list" value="fee Detail">
                       			 Fee Detail Head Wise
                     	</div>
            	...
            	<div class="col-md-6">
            	 ...
            	 <div class="col-md-6">
            		...
            		<div class="form-group">
            			...
            			<input type="text" style="margin-left: 100px;" value="<?php if($salary){ echo $salary;}?>"  disabled="disabled"/>
            		</div>
            		<div class="form-group">
